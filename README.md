...
## 🧠 Intelligent Mapping
Directo includes a built-in **RTL Registry**. If you call `directo.setLanguage('ar')`, it automatically knows it's an RTL language and swaps your entire layout instantly—even with zero custom configuration.
